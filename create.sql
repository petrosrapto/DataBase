...
CREATE TABLE ins_phone (
  ins_id SMALLINT UNSIGNED NOT NULL,
...
CREATE TABLE executive (
  ex_id SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT,
  name VARCHAR(45) NOT NULL,
  PRIMARY KEY (ex_id)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE assessment (
  ass_id SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE researcher (
  res_id SMALLINT UNSIGNED NOT NULL AUTO_INCREMENT,
  ins_id SMALLINT UNSIGNED NOT NULL,
...
CREATE TABLE project (
  ...
  ex_id SMALLINT UNSIGNED NOT NULL,
  ass_id SMALLINT UNSIGNED NOT NULL,
  ass_res_id SMALLINT UNSIGNED NOT NULL,
  sup_res_id SMALLINT UNSIGNED NOT NULL,
