...
class ProjectUpdateForm(FlaskForm):
    ...
    ins_id = SelectField(label = "Managed by Institution", coerce=int, validators = [InputRequired(), DataRequired(message = "Institution's ID is a required field."), NumberRange(min=1, message="Institution's ID is a required field.")])
    ...
    ass_id = SelectField(label = "Assessment", coerce=int, validators = [InputRequired(), DataRequired(message = "Assessment's ID is a required field."), NumberRange(min=1, message="Assessment's ID is a required field.")])
